...
import me.drizzy.practice.util.command.command.DrinkAuthorizer;
import me.drizzy.practice.util.command.command.DrinkCommandContainer;
...
public interface CommandService {
     ...
     * @param handler Object that has the {@link me.drizzy.practice.util.command.annotation.Command} annotated methods
     ...
     * {@link me.drizzy.practice.util.command.annotation.Command} annotation set name = ""
     ...
     * @param handler The object that has the {@link me.drizzy.practice.util.command.annotation.Command}
    ...
    /**
     * Start binding a class type to a {@link me.drizzy.practice.util.command.parametric.DrinkProvider} or instance.
     ...
     * @param annotation The annotation to use for the modifier (must have {@link me.drizzy.practice.util.command.annotation.Modifier} annotated in it's class)
