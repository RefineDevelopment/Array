...
import me.drizzy.practice.util.command.annotation.Duration;
import me.drizzy.practice.util.command.annotation.Sender;
import me.drizzy.practice.util.command.annotation.Text;
import me.drizzy.practice.util.command.argument.ArgumentParser;
import me.drizzy.practice.util.command.argument.CommandArgs;
import me.drizzy.practice.util.command.exception.*;
import me.drizzy.practice.util.command.modifier.DrinkModifier;
import me.drizzy.practice.util.command.modifier.ModifierService;
import me.drizzy.practice.util.command.parametric.BindingContainer;
import me.drizzy.practice.util.command.parametric.DrinkBinding;
import me.drizzy.practice.util.command.parametric.DrinkProvider;
import me.drizzy.practice.util.command.parametric.ProviderAssigner;
import me.drizzy.practice.util.command.parametric.binder.DrinkBinder;
import me.drizzy.practice.util.command.provider.*;
import me.drizzy.practice.util.command.provider.spigot.CommandSenderProvider;
import me.drizzy.practice.util.command.provider.spigot.PlayerProvider;
import me.drizzy.practice.util.command.provider.spigot.PlayerSenderProvider;
