...
public class PartyHelpCommand {
    public void execute(final Player player) {
        ...
        player.sendMessage(CC.CHAT_BAR);
        player.sendMessage(CC.translate(" &8• &b/party help &8(&7&oDisplays the help message&8&o)"));
        player.sendMessage(CC.translate(" &8• &b/party create &8(&7&oCreates a party instance&8&o)"));
        player.sendMessage(CC.translate(" &8• &b/party leave &8(&7&oLeave your current party&8&o)"));
        player.sendMessage(CC.translate(" &8• &b/party info &8(&7&oDisplays your party information&8&o)"));
        ...
        player.sendMessage(CC.translate(" &8• &b/party open &8(&7&oOpen your party for others to join&8&o)"));
        player.sendMessage(CC.translate(" &8• &b/party close &8(&7&oClose your party for others to join&8&o)"));
