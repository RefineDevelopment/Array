...
public class ManagePartySettings extends Menu {
    ...
    private final Button placeholder = Button.placeholder(Material.STAINED_GLASS_PANE, (byte) 3, "");
        ...
        public void clicked(final Player player, final ClickType clickType) {
            ...
            switch (partyManageType) {
                ...
                case PUBLIC: {
                    ...
                    if (!party.isPublic()) {
                        party.setPrivacy(PartyPrivacyType.OPEN);
                    } else {
                        party.setPrivacy(PartyPrivacyType.CLOSED);
                    }
                    break;
                }
            }
