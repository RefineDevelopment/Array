...
public class Hotbar
{
    ...
    public static void preload() {
        ...
        Hotbar.items.put(HotbarItem.PARTY_EVENTS, new ItemBuilder(Material.DIAMOND_AXE).name(CC.AQUA + "Party Events" + CC.GRAY + " (Right-Click)").build());
        ...
        Hotbar.items.put(HotbarItem.OTHER_PARTIES, new ItemBuilder(Material.REDSTONE_TORCH_ON).name(CC.AQUA + "Duel Other Parties" + CC.GRAY + " (Right-Click)").build());
        ...
        Hotbar.items.put(HotbarItem.SUMO_LEAVE, new ItemBuilder(Material.INK_SACK).durability(1).name(CC.RED + "Leave Sumo" + CC.GRAY + " (Right-Click)").build());
        Hotbar.items.put(HotbarItem.GULAG_EVENT, new ItemBuilder(Material.DIAMOND_HOE).name(CC.AQUA + "Glock 19 " + CC.GRAY + "(Loaded)").build());
        Hotbar.items.put(HotbarItem.BRACKETS_LEAVE, new ItemBuilder(Material.INK_SACK).durability(1).name(CC.RED + "Leave Gulag" + CC.GRAY + " (Right-Click)").build());
        ...
        switch (layout) {
            case LOBBY: {
                if (profile.getParty() == null) {
                    ...
                    toReturn[7] = Hotbar.items.get(HotbarItem.LEADERBOARDS_MENU);
            ...
            case PARKOUR_SPECTATE: {
                toReturn[0] = Hotbar.items.get(HotbarItem.PARKOUR_SPAWN);
                toReturn[8] = Hotbar.items.get(HotbarItem.PARKOUR_LEAVE);
                break;
            }
