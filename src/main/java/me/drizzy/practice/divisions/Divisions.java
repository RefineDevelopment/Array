package me.drizzy.practice.divisions;

import me.drizzy.practice.Array;
import me.drizzy.practice.divisions.meta.DivisionMeta;
...
public class Divisions {
    ...
    public void loadDivisions() {
        ...
        try {
            Array.getInstance().getDivisionsConfig().getConfiguration().save(Array.getInstance().getDivisionsConfig().getFile());
        } catch (IOException e) {
            //
        }
    }
