...
public class ArrayHCFCommand {
    public void execute(final Player player) {
        if (Array.getInstance().getMainConfig().getBoolean("Array.HCF-Enabled")) {
            ...
            player.sendMessage(CC.translate("&7named &cHCFTeamFight &7, this should usually automatically"));
            ...
            player.sendMessage(CC.translate("&c&lBard Kit"));
            ...
            player.sendMessage(CC.translate("&7Bard Kit MUST have Golden Armor and be named &cHCFBARD,"));
            player.sendMessage(CC.translate("&7rest you can add the normal bard items."));
            player.sendMessage(CC.translate(""));
            player.sendMessage(CC.translate("&c&lArcher Kit"));
            player.sendMessage(CC.translate("&7In order for archer to work, the Archer kit MUST be named"));
            player.sendMessage(CC.translate("&cHCFARCHER &7and must have Leather as its armor and a bow,"));
            player.sendMessage(CC.translate("&7rest you can add it as you wish."));
            player.sendMessage(CC.translate(""));
            player.sendMessage(CC.translate("&c&lRogue Kit"));
            player.sendMessage(CC.translate("&7In order for rogue to work, the Rogue kit MUST be named"));
            player.sendMessage(CC.translate("&cHCFROGUE &7and must have Chain-mail as its armor,"));
            player.sendMessage(CC.translate("&7rest you can add it as you wish."));
            player.sendMessage(CC.translate(""));
