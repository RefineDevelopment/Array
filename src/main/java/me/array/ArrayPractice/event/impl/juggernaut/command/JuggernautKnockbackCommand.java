...
@CommandMeta(label = "juggernaut setknockbackprofile", permission = "practice.staff")
public class JuggernautKnockbackCommand {
    ...
    public void execute(Player player, @CPL("knockback-profile") String kb) {
        if (kb == null) {
            ...
            Array.get().getJuggernautManager().setJuggernautKnockbackProfile(kb);
