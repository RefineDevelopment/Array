package me.array.ArrayPractice.event.impl.tournament;
...
public class Tournament {
    ...
    @Getter private List<Party> participants = new ArrayList<Party>() {
        @Override
    ...
    private List<TournamentMatch> tournamentMatches = Lists.newArrayList();
