        ...
        switch (layout) {
            case LOBBY: {
                if (profile.getParty() == null) {
                    final boolean activeEvent = (Practice.getInstance().getSumoManager().getActiveSumo() != null && Practice.getInstance().getSumoManager().getActiveSumo().isWaiting()) || (Practice.getInstance().getBracketsManager().getActiveBrackets() != null && Practice.getInstance().getBracketsManager().getActiveBrackets().isWaiting()) || (Practice.getInstance().getLMSManager().getActiveLMS() != null && Practice.getInstance().getLMSManager().getActiveLMS().isWaiting()) || (Practice.getInstance().getParkourManager().getActiveParkour() != null && Practice.getInstance().getParkourManager().getActiveParkour().isWaiting()) || (Practice.getInstance().getSpleefManager().getActiveSpleef() != null && Practice.getInstance().getSpleefManager().getActiveSpleef().isWaiting());
