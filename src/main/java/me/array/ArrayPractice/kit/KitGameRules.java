...
public class KitGameRules {
	...
	@Getter @Setter private boolean antifoodloss;
	@Getter @Setter private boolean infinitespeed;
	@Getter @Setter private boolean infinitestrength;
	@Getter @Setter private boolean ffacenter;
	@Getter @Setter private boolean noitems;
	...
	@Getter @Setter private boolean waterkill;
	@Getter @Setter private boolean lavakill;
