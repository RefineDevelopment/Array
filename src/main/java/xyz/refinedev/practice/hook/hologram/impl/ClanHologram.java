...
public class ClanHologram extends PracticeHologram {
    ...
    public void spawn() {
        ...
        for ( String line : config.getStringList("SETTINGS.CLAN.LINES") ) {
            if (line.contains("<top>")) {
                int position = 1;
                for ( LeaderboardsAdapter leaderboardsAdapter : leaderboardsManager.getClanLeaderboards()) {
                    apiHologram.appendTextLine(config.getString("SETTINGS.CLAN.FORMAT")
