...
public class YamlCommenter {
    ...
    public void saveComments(File file, boolean loadWorldConfig) throws IOException {
        ...
        for (Map.Entry<String, String> _comment : comments.entrySet()) {
            if (!loadWorldConfig && _comment.getKey().startsWith("world-settings.")) continue; // World settings are initialized after CarbonConfig, while CarbonConfig loads their comments.
            ...
            String prefix = YamlUtils.repeat(" ", getIndentation(lines.get(line))) + "# ";
