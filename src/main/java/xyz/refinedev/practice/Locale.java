...
public enum Locale {
    ...
    CLAN_KICKED("CLAN.KICKED_BROADCAST", "&8[&cClan&8] &c<kicked> &7has been kicked from the Clan!"),
    CLAN_BANNED("CLAN.BANNED_BROADCAST", "&8[&cClan&8] &c<banned> &7has been banned from the Clan!"),
    ...
    CLAN_IS_BANNED("CLAN.PLAYER_BANNED", "&8[&c&lClan&8] &7That player has been from this clan, use &c/clan unban <profile> &7to unban."),
    ...
    CLAN_INFO("CLAN.INFO", Arrays.asList("&c&m--------&7&m-------------------------------------&c&m--------", "&c<clan_name> Information &8[&7<clan_members_size>/<clan_members_limit>]", "&c&m--------&7&m-------------------------------------&c&m--------", "&8 \u2022 &cLeader: &f<clan_leader>", "&8 \u2022 &cMembers: &f<clan_members>", "&8 \u2022 &cClan ELO: &f<clan_elo>", "&8 \u2022 &cDate Created: &f<clan_created>", "&8 \u2022 &cWinstreak: &f<clan_winsteak> &7\uff5c &f<clan_highest_winstreak>", "&c&m--------&7&m-------------------------------------&c&m--------")),
    ...
    ERROR_UNAVAILABLE("ERROR.UNAVAILABLED", "&7You are currently busy, please finish your task and then try again."),
    ...
    EVENT_NO_COOLDOWN("EVENTS.NO_COOLDOWN", "&7There is no currently active <event_name> Event cooldown."),
    EVENT_COOLDOW_RESET("EVENTS.COOLDOWN_RESET", "&7Successfully reset the &c<event_name> Event &7cooldown."),
    ...
    EVENT_SPAWN("EVENTS.SPAWWN", "&7Updated &cBrackets's &7spawn location &c<position>&7."),
